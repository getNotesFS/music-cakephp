...
/**
 * Discographies Controller
 *
 * @property \App\Model\Table\DiscographiesTable $Discographies
 */
class DiscographiesController extends AppController
{
    public $entity_name = 'discography';
    public $entity_name_plural = 'discographies';
    ...
    public $table_buttons = [
        ...
        'Borrar' => [
            ...
            'options' => [
                'confirm' => '¿Está seguro de que desea eliminar la discografía?',
                'class' => 'button'
            ]
        ]
    ];
    ...
    public function edit($id = null, $locale = null)
    {
        ...
        if ($this->request->is(['patch', 'post', 'put'])) {
            ...
            if ($entity->getErrors()) {
                $this->Flash->error(__('No se ha podido guardar la discografía. Por favor, intente nuevamente.'));
            }

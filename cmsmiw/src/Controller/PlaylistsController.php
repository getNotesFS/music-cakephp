 ...
 *
 * @property \App\Model\Table\SongsTable $Playlists
 */
class PlaylistsController extends AppController
{
    public $entity_name = 'playlist';
    public $entity_name_plural = 'playlists';
    ...
    public $table_buttons = [
        ...
        'Borrar' => [
            ...
            'options' => [
                'confirm' => '¿Está seguro de que desea eliminar la playlist?',
                'class' => 'button'
            ]
        ]
    ];
    ...
    public $paginate = [
        'limit' => 20,
        'order' => [
            'Playlists.published_date' => 'DESC',
            'Playlists.published_time' => 'DESC'
        ]
    ];
    ...
    public function add()
    {
        ...
        //$songs = $this->{$this->getName()}->Songs->find('list')->contain(['Albums.Artists']);
        $songs = $this->{$this->getName()}->Songs->find('list', [
            'keyField' => 'id',
            'valueField' => function ($song) {
                return $song->name . ' - ' . $song->album->artist->name;
            }
        ...
        $this->set(compact('entity', 'genders', 'songs'));
    }

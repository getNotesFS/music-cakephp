           ...
           tinymce.remove();
            ...
            function initStandardEditor() {
                tinymce.init({
                    ...
                    height: 400,
                    oninit: "setPlainText",
                    plugins: 'code anchor autolink charmap codesample emoticons link autosave media image lists  searchreplace visualblocks  wordcount table template ',
                    toolbar: 'undo redo | cut copy paste | blocks fontfamily fontsize | styleselect template | bold italic underline strikethrough | forecolor | link image media table | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent superscript | numlist bullist indent outdent | emoticons charmap | removeformat code',
                    menubar: false,
                    convert_urls: false,
            ...
            function initHeaderEditor() {
                tinymce.init({
                    ...
                    toolbar: 'undo redo | cut copy paste | blocks fontfamily fontsize | styleselect template | forecolor | link image media table | alignleft aligncenter alignright alignjustify | removeformat code',
                    menubar: false,
                    convert_urls: false,
                    style_formats_merge: false,
                    init_instance_callback: function (editor) {
